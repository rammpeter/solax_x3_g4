...
parse_32(83, 10, @data[83], @data[84], 'kWh', 'EPS Energy total')
parse_32(84, 10, @data[83], @data[84], 'kWh', 'EPS Energy total')
parse(85, 10, 'kWh', 'EPS Energy today')
...
parse_32(90, 100, @data[90], @data[91], 'kWh', 'Feed-in energy into grid today')
parse_32(91, 100, @data[90], @data[91], 'kWh', 'Feed-in energy into grid today')
parse_32(92, 100, @data[92], @data[93], 'kWh', 'Energy consumption from grid today')
parse_32(93, 100, @data[92], @data[93], 'kWh', 'Energy consumption from grid today')
parse(94)
parse(95)
parse(96)
parse(97)
